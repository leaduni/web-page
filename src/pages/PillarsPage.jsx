...
const pillars = [
  {
    ...
    events: [
      ...
      {
        title: 'Taller de Liderazgo Efectivo',
  ...
  },
  {
    ...
    mission:
      'Fomentar una cultura de excelencia académica y aprendizaje continuo entre los estudiantes universitarios.',
    activities: [
  ...
  },
  {
    ...
    events: [
      ...
      {
        title: 'Taller de Gestión',
        image: 'https://images.pexels.com/photos/3184418/pexels-photo-3184418.jpeg',
        date: '10 de Junio, 2025',
      },
      {
        title: 'Desarrollo de Equipo',
        image: 'https://images.pexels.com/photos/3184418/pexels-photo-3184418.jpeg',
