          ...
          <div className="relative w-full max-w-xl">
            <div className="relative rounded-3xl overflow-hidden shadow-[0_0_30px_-5px_rgba(147,51,234,0.3)] hover:shadow-[0_0_40px_-5px_rgba(147,51,234,0.4)] transform hover:scale-105 transition-all duration-500">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/80 via-black/50 to-transparent">
                ...
                <p className="text-white/90">Conoce al equipo detrás de LEAD UNI y únete a nuestra comunidad</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-black/30 backdrop-blur-sm rounded-3xl p-10 border border-white/10 w-full max-w-xl">
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="nombre" className="block text-white/80 mb-2 text-sm">Nombre Completo</label>
                  <input
                    type="text"
                    id="nombre"
                ...
                <div>
                  <label htmlFor="email" className="block text-white/80 mb-2 text-sm">Correo Electrónico</label>
                  <input
                    type="email"
                    id="email"
              ...
              <div>
                <label htmlFor="asunto" className="block text-white/80 mb-2 text-sm">Asunto</label>
                <select
                  id="asunto"
              ...
              <div>
                <label htmlFor="mensaje" className="block text-white/80 mb-2 text-sm">Mensaje</label>
                <textarea
                  id="mensaje"
                  rows={4}
